        ...
        <div className="pageContainer">
            ...
            <div className="landingContent">
                <div className="landingStory">
                    Welcome to my personal website! I am Yngvi Leó Þráinsson, an Icelander who graduated from Reykjavík University with a BSc. in Computer Science in June of 2022. For more info about me check my <Link to={about}>About Me</Link> page, and my past projects will be found within the <Link to={projects}>Projects</Link> page.
                </div>
